...
const MovieCard = ({movie}) => {
  ...
  return (
    ...
    rounded-2xl hover:-translate-y-1 transition duration-300 w-66'>
        <img onClick={()=> {navigate('/movies/${movie.id}'); scrollTo(0,0)}} src={movie.backdrop_path} alt=" " className='rounded-lg h-52 w-full object-cover 
        object-bottom cursor-pointer'/>
